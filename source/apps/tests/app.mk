...
APP_LIS3DSH_OBJECTS:=test_LIS3DSH.o LIS3DSH.o mems.o
APP_LIS3DSH_C_VPATH:=source/apps/tests

APP_LIS3DH_TARGET:=LIS3DH
APP_LIS3DH_OBJECTS:=test_LIS3DH.o LIS3DH.o mems.o
APP_LIS3DH_C_VPATH:=source/apps/tests
